...
coordinates=""
headlight="OFF"
eye_cascade=cv2.CascadeClassifier('home/nishant/Python-3/D/parojosG.xml')
face_cascade=cv2.CascadeClassifier('home/nishant/Python-3/D/haarcascade_frontalface_default.xml')
